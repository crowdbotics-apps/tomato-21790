"""tomato_21790 URL Configuration
...
admin.site.site_header = "Tomato"
admin.site.site_title = "Tomato Admin Portal"
admin.site.index_title = "Tomato Admin"

# swagger
api_info = openapi.Info(
    title="Tomato API",
    default_version="v1",
    description="API documentation for Tomato App",
)
